...
const BUILTIN_PRODUCTS=[{id:'boya',name:'伯牙绝弦'},{id:'coconut',name:'生椰拿铁'},{id:'grape',name:'多肉葡萄'},{id:'lemon',name:'冰鲜柠檬水'},{id:'mango',name:'杨枝甘露'}];
const BRAND_CATALOG=[
  {brand:'瑞幸咖啡',type:'咖啡',drinks:[['生椰拿铁',480,80,'咖啡','coconut'],['酱香拿铁',480,75],['陨石拿铁',480,80],['厚乳拿铁',480,80],['橙C美式',480,120],['标准美式',480,150],['抹茶好喝椰',480,30],['丝绒拿铁',480,80],['椰青冰萃',480,120]]},
